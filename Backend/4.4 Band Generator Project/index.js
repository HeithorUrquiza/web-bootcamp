...
app.post("/submit", (req, res) => {
  ...
  const randomAdj = adj[rand1]
  const randomNoun = noun[rand2]

  res.render("index.ejs", {
    adj: randomAdj[0].toUpperCase() + randomAdj.slice(1, randomAdj.length - 1), 
    noun: randomNoun[0].toUpperCase() + randomNoun.slice(1, noun.length - 1)
  })
});
